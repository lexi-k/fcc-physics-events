...
class Producer(SQLModel, table=True):
    ...
    samples: list["Sample"] = Relationship(
        back_populates="producers", link_model=ProducerSampleLink
    )
...
class Sample(SQLModel, table=True):
    ...
    file_type: Optional[str] = Field(
        sa_column=Column("file-type", String, default=None)
    )
    ...
    cross_section: Optional[float] = Field(
        sa_column=Column("cross-section", Float, default=None)
    )
    n_events: Optional[int] = Field(sa_column=Column("n-events", Integer, default=None))
    sum_of_weights: Optional[float] = Field(
        sa_column=Column("sum-of-weights", Float, default=None)
    )
    n_files_good: Optional[int] = Field(
        sa_column=Column("n-files-good", Integer, default=None)
    )
    n_files_bad: Optional[int] = Field(
        sa_column=Column("n-files-bad", Integer, default=None)
    )
    n_files_eos: Optional[int] = Field(
        sa_column=Column("n-files-eos", Integer, default=None)
    )
    size: Optional[int]
    ...
    matching_params: Optional[str] = Field(
        sa_column=Column("matching-params", String, default=None)
    )
    k_factor: Optional[float] = Field(sa_column=Column("k-factor", Float, default=None))
    matching_eff: Optional[float] = Field(
        sa_column=Column("matching-eff", Float, default=None)
    )
    status: str
    ...
    producers: list["Producer"] = Relationship(
        back_populates="samples", link_model=ProducerSampleLink
    )
