  ...
  <body>
    ...
    <article class="container-lg">
      ...
      <div class="list-group mt-1">
        ...
        <a class="list-group-item list-group-item-action" href="<?= BASE_URL ?>/FCCee/delphes/spring2021/idea-3t">Spring 2021 | IDEA 3T</a>
        <a class="list-group-item list-group-item-action" href="<?= BASE_URL ?>/FCCee/delphes/spring2021/idea-fullsilicone">Spring 2021 | IDEA Full Silicone</a>
        <a class="list-group-item list-group-item-action" href="<?= BASE_URL ?>/FCCee/delphes/spring2021-training/idea">Spring 2021&ndash;training | IDEA</a>
        <a class="list-group-item list-group-item-action" href="<?= BASE_URL ?>/FCCee/delphes/dev/idea">Dev | IDEA</a>
      </div>
