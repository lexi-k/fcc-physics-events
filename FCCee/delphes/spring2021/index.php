  ...
  <body>
    ...
    <article id="sample-article" class="container-lg">
      ...
      <div class="list-group mt-5">
        <a class="list-group-item list-group-item-action" href="<?= BASE_URL ?>/FCCee/delphes/spring2021/idea">IDEA</a>
        <a class="list-group-item list-group-item-action" href="<?= BASE_URL ?>/FCCee/delphes/spring2021/idea-3t">IDEA 3T</a>
        <a class="list-group-item list-group-item-action" href="<?= BASE_URL ?>/FCCee/delphes/spring2021/idea-fullsilicone">IDEA FullSilicone</a>
      </div>
