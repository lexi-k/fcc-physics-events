...
<?php
$txt_file    = file_get_contents('data/FCCee/Delphesevents_fcc_tmp_v03.txt');
$rows        = explode("\n", $txt_file);
?>
...
<h2>Delphes FCCee Physic events tmp version v03 (IDEA with Track Covariance full matrix lower triangle)</h2>
