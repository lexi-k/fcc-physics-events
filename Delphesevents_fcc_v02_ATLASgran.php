<html>
<head>
<title>fcc v02 ATLAS Granularity</title>
...
<?php
$txt_file    = file_get_contents('data/Delphesevents_fcc_v02_ATLASgran.txt');
$rows        = explode("\n", $txt_file);
?>
...
<h2>Delphes FCC Physic events v0.2 with ATLAS Granularity</h2>
