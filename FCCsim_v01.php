...
<?php
$txt_file    = file_get_contents('/afs/cern.ch/user/h/helsens/www/FCCsim_v01.txt');
$rows        = explode("\n", $txt_file);
?>
...
$lname=array('NO','Dir','Nevents','Nfiles','Neos','Nbad', 'Size(GB)','helsens', 'cneubuse', 'azaborow', 'aleksa', 'novaj');
