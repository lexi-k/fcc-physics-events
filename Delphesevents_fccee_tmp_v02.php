...
<?php
$txt_file    = file_get_contents('data/FCCee/Delphesevents_fcc_tmp_v02.txt');
$rows        = explode("\n", $txt_file);
?>
...
<h2>Delphes FCCee Physic events tmp version v02 (IDEA with Track Covariance)</h2>
