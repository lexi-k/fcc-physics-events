...
<html lang="en">
  <head>
    ...
    <title>Dev | Delphes | FCC-ee | FCC Physics Events</title>
  ...
  <body>
    ...
    <article id="sample-article" class="container-lg">
      <h1 class="mt-5">FCC-ee | Delphes | Dev Samples</h1>

      <div class="list-group mt-5">
        <a class="list-group-item list-group-item-action" href="<?= BASE_URL ?>/fcc-ee/delphes/dev/idea">IDEA</a>
      </div>
      ...
      <p class="mt-3">
        ...
        generation of the <code>dev</code> samples was:
